...
TOOLS=(
  ...
  "r2|binary-re|radare2 CLI analysis|r2|r2 -v|"
  "rabin2|binary-re|Binary metadata extraction|rabin2|rabin2 -v|"
  ...
  "idapro|binary-re|IDA Pro commercial reverse-engineering suite (use Ghidra/radare2 instead)|idat|idat -v|/opt/idapro/idat;/Applications/IDA Professional.app;/Applications/IDA Free.app"
  "burpsuite|pentest-tools|BurpSuite desktop application (optional proxy UI)|burpsuite|burpsuite --version|/Applications/Burp Suite Professional.app;/Applications/Burp Suite Community Edition.app"
  ...
  "burp-mcp-full|pentest-tools|Local Burp MCP extension and stdio bridge (not bundled)|none|none|$REPO_ROOT/burp-mcp-full/mcp-bridge.js"
  "binwalk|firmware-pentest|Firmware extraction and analysis|binwalk|binwalk --version|"
